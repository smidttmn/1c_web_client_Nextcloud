<div class="section">
    ...
    <div id="one_c_web_client_data"
         ...
         data-url-placeholder="<?php p(addslashes($l->t('URL базы (например, https://192.168.1.100/buh/)'))); ?>"
        ...
        <div id="databases-container">
            <?php if (empty($_['databases'])): ?>
                <div class="database-entry">
                    ...
                    <input type="text" class="db-url" placeholder="<?php p($l->t('URL базы (например, https://192.168.1.100/buh/)')); ?>" />
            ...
            <?php else: ?>
                <?php foreach ($_['databases'] as $db): ?>
                    <div class="database-entry">
                        ...
                        <input type="text" class="db-url" value="<?php p($db['url']); ?>" placeholder="<?php p($l->t('URL базы (например, https://192.168.1.100/buh/)')); ?>" />
