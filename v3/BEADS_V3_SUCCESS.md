...
<VirtualHost *:443>
    ...
    Header always set Content-Security-Policy "frame-ancestors 'self' https://cloud.smidt.keenetic.pro; frame-src *; connect-src *; script-src 'self' 'unsafe-inline' 'unsafe-eval' *; style-src 'self' 'unsafe-inline' *;"
...
1. Откройте админ-панель: `https://cloud.smidt.keenetic.pro/index.php/settings/admin/one_c_web_client_v2`
...
4. Нажмите "Сохранить"
5. База появится в приложении: `https://cloud.smidt.keenetic.pro/index.php/apps/one_c_web_client_v2/onec`
...
2. Попробуйте зайти на `https://cloud.smidt.keenetic.pro/buh/`
